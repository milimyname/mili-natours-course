    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "".concat(type === 'data' ? 'http://127.0.0.1:3000/api/v1/users/updateMe' : 'http://127.0.0.1:3000/api/v1/users/updateMyPassword');
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWlsaS1teW5hbWUiLCJhIjoiY2t1Z3NzNDQ1MjUweTJwbXZ0Y3A4MWdlNiJ9.Dgu3nwLahgy6W_VFdK8QEQ';
...
var stripe = Stripe('pk_test_51Jio58BXP1rxHjlfysCG5lF5ty57MDQyaYMVBk0M6EA71vi6C9gWRoZCicGwK4xXuL6VPG2G1Rkje8TfSXtalNr000n6whLkZU');
